...
<tr>
    <td><?php echo $fila['Ndocumento']; ?></td>
...
<a class="btn btn-info" href="editar.php?id=<?php echo $fila['Ndocumento']?> ">
<i class="fa fa-edit"></i> </a>

  <a class="btn btn-danger"  href="eliminar.php?id=<?php echo $fila['Ndocumento']?>">
