									...
									<div class="single-product-item">
										...
										<?php if ($suscripcion['CompartirPerfil'] == 'SI' /* && $user['Compartido'] == 1 */) { ?>
											<div>
												...
												<input type="checkbox" name="Privacidad" id="<?= $PrivacidadQR ?>" <?php if ($code['Privacidad'] == 1) {
																														echo 'checked';
																													} ?>>
												<p id="<?= $EstadoQR ?>" style="font-weight: bolder; color:purple;text-transform: uppercase; border: 4px solid purple; border-radius:5px; display:inline-block; padding:.7rem; "><?php if ($code['Privacidad'] == 1) {
																																																									echo 'publico';
																																																								} else {
																																																									echo 'privado';
																																																								} ?></p>
