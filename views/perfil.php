        ...
        <div class="perfil-usuario-body">
            ...
            <div class="perfil-usuario-footer">
                <ul class="lista-datos">
                    <li><i class="icono fas fa-map-signs"></i> Direccion: <strong>
                    <?php echo $_SESSION['Direccion'] ?></strong> </li>
                    <li><i class="icono fas fa-phone"></i> Telefono: <strong>
                    <?php echo $_SESSION['Telefono'] ?></strong> </li>
                    <li><i class="icono fas fa-user"></i> Genero: <strong>
                    <?php echo $_SESSION['Genero'] ?></strong> </li>
                    <li><i class="icono fas fa-envelope"></i> Correo: <strong>
                    <?php echo $_SESSION['Correo'] ?></strong> </li>                 
                </ul>
                <ul class="lista-datos">
                    <li><i class="icono fas fa-map-marker-alt"></i> Localidad:</li  >
                    <li><i class="icono fas fa-calendar-alt"></i> Fecha nacimiento: <strong>
                    <?php echo $_SESSION['FechaNacimiento'] ?></strong> </li>
                    <li><i class="icono fas fa-house-damage"></i>Estrato:</li>
                    <li><i class="icono fas fa-briefcase-medical"></i> EPS:</li>
                </ul>
            </div>
